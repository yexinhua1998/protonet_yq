...
class EfficientNet(nn.Module):
    def __init__(self, num_classes=1000,
                 width_ratio=1.0, depth_ratio=1.0, image_size=299, dropout_rate=0.2,
        ...
        self.conv_first = Conv2dBNSwish(1, out_channels, 3, 2, 1, False, bn_momentum, bn_eps, image_size, norm_layer)
